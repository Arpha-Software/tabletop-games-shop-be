...
public class ProductController {
    ...
    @Operation(summary = "Get available filter options", description = "Retrieves all available, distinct values for product filters like languages, genres, categories, etc., to populate UI filter menus. The results are cached for performance.")
    @GetMapping("/filters")
