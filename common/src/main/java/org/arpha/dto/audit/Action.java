...
public enum Action {
    ...
    CREATE_PRODUCT, DELETE_PRODUCT_BY_ID, ADD_GENRE_TO_PRODUCT, ADD_CATEGORY_TO_PRODUCT, FIND_PRODUCT_BY_ID,

    CREATE_POST, UPDATE_POST, DELETE_POST, FIND_POST_BY_ID,
